...
const I18N = {
  ja: {
    ui: {
      ...
      videoAutoplayHintDesktop: '予告編は自動再生されます。音量はYouTubeプレーヤーから変更できます。',
      langLabel: '言語',
      langJa: '日本語',
      langEn: 'English',
      langKo: '한국어'
  ...
  en: {
    ui: {
      ...
      videoAutoplayHint: 'The trailer autoplays muted on phones and tablets—tap the YouTube player to unmute.',
      videoAutoplayHintDesktop: 'The trailer autoplays with sound on desktop—adjust volume in the player if needed.',
      langLabel: 'Language',
      langJa: 'Japanese',
      langEn: 'English',
      langKo: 'Korean'
  ...
  ko: {
    ui: {
      ...
      videoAutoplayHint: '모바일·태블릿에서는 정책상 예고편이 음소거로 자동 재생됩니다. 플레이어에서 음소거를 해제하세요.',
      videoAutoplayHintDesktop: 'PC에서는 소리와 함께 예고편이 자동 재생됩니다. 필요하면 플레이어에서 볼륨을 조절하세요.',
      langLabel: '언어',
      langJa: '일본어',
      langEn: 'English',
      langKo: '한국어'
